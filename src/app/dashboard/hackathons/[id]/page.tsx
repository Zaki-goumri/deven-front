...
export default function HackathonDetailsPage({ params }: { params: { id: string } }) {
  ...
  const mockHackathons: Hackathon[] = [
    ...
    organizationLogo: "TCA",
      description: "Build innovative AI solutions to solve real-world problems. Focus on machine learning, computer vision, and natural language processing. Join thousands of developers worldwide in this exciting challenge!",
    participants: 1247,
  ...
  useEffect(() => {
    ...
    const fetchHackathon = async () => {
      ...
      const foundHackathon = mockHackathons.find(h => h.id === parseInt(params.id));
  ...
  const handleRegistrationSubmit = (e: React.FormEvent) => {
    ...
    console.log("Registration submitted:", { hackathon, form: registrationForm });
  ...
  const getEventTypeColor = (type: string) => {
    switch (type.toLowerCase()) {
      case "registration": return "bg-[#00C853]/20 text-[#00C853]";
      case "ceremony": return "bg-[#00CFFF]/20 text-[#00CFFF]";
      case "networking": return "bg-[#6A00FF]/20 text-[#6A00FF]";
      case "hacking": return "bg-[#FF3B30]/20 text-[#FF3B30]";
      case "workshop": return "bg-[#FF9500]/20 text-[#FF9500]";
      case "meal": return "bg-[#34C759]/20 text-[#34C759]";
      case "mentorship": return "bg-[#AF52DE]/20 text-[#AF52DE]";
      case "deadline": return "bg-[#FF3B30]/20 text-[#FF3B30]";
      case "presentation": return "bg-[#007AFF]/20 text-[#007AFF]";
      case "judging": return "bg-[#FF9500]/20 text-[#FF9500]";
    ...
    return (
      <div className="min-h-screen bg-[#0A0A0A] flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">Hackathon not found</h3>
        ...
        <div className="relative h-full flex items-end p-8">
          <div className="flex items-end space-x-6 w-full">
            ...
            <div className="flex-1 text-white">
              ...
              <p className="text-xl text-[#C7C7C7] mb-4">{hackathon.organization}</p>
            ...
            <div className="bg-[#121212] rounded-2xl p-6 border border-white/10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {hackathon.prizeBreakdown.map((prize, index) => (
                  <div key={index} className="bg-[#1A1A1A] rounded-xl p-4 border border-white/5">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-lg font-semibold text-white">{prize.place} Place</span>
                      <span className="text-2xl font-bold text-[#00CFFF]">{prize.amount}</span>
                    </div>
            ...
            <div className="bg-[#121212] rounded-2xl p-6 border border-white/10">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-[#C7C7C7] text-sm">
                  {hackathon.type === 'hackathon' && 'Build innovative solutions in a time-limited environment'}
                  {hackathon.type === 'ideathon' && 'Focus on generating and developing innovative ideas'}
              ...
              <h2 className="text-2xl font-bold text-white mb-4 flex items-center">
                ...
                <div className="bg-[#1A1A1A] rounded-xl p-4 border border-white/5">
                   <div className="text-center mb-4">
                     ...
                     <div className="text-[#A0A0A0] text-sm">Regular Registration</div>
                   </div>
                   {hackathon.pricing.earlyBirdFee && (
                     <div className="text-center mb-4 p-3 bg-[#00C853]/10 rounded-lg">
                       <div className="text-2xl font-bold text-[#00C853] mb-1">{hackathon.pricing.earlyBirdFee}</div>
                       <div className="text-[#00C853] text-sm">Early Bird (Until {new Date(hackathon.pricing.earlyBirdDeadline!).toLocaleDateString()})</div>
                     </div>
                   )}
                 </div>
                   ...
                   <ul className="space-y-2">
                     {hackathon.pricing.includes.map((item, index) => (
                       <li key={index} className="flex items-center space-x-2 text-[#C7C7C7]">
             ...
             <div className="bg-[#121212] rounded-2xl p-6 border border-white/10">
               ...
               <div className="space-y-6">
                 {hackathon.schedule.map((day, dayIndex) => (
                   <div key={dayIndex} className="border-l-4 border-[#00CFFF] pl-6">
                     <h3 className="text-xl font-bold text-white mb-2">{day.day} - {new Date(day.date).toLocaleDateString()}</h3>
                     <div className="space-y-4">
                       {day.events.map((event, eventIndex) => (
                         <div key={eventIndex} className="bg-[#1A1A1A] rounded-lg p-4 border border-white/5">
                           <div className="flex items-start justify-between mb-2">
                             <div className="flex items-center space-x-3">
                               <div className="w-12 text-[#00CFFF] font-semibold text-sm">{event.time}</div>
                           ...
                           <p className="text-[#A0A0A0] text-sm ml-15">{event.description}</p>
                         </div>
                       ))}
                     </div>
                   </div>
             ...
             <div className="bg-[#121212] rounded-2xl p-6 border border-white/10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                 {hackathon.sponsors.map((sponsor, index) => (
                   <div key={index} className="bg-[#1A1A1A] rounded-xl p-4 border border-white/5 hover:border-[#00CFFF]/20 transition-colors">
                     <div className="text-center space-y-3">
                       <div className={`w-16 h-16 rounded-xl flex items-center justify-center mx-auto ${
                         sponsor.tier === 'Platinum' ? 'bg-gradient-to-r from-[#E5E4E2] to-[#B8860B]' :
                         sponsor.tier === 'Gold' ? 'bg-gradient-to-r from-[#FFD700] to-[#FFA500]' :
                      ...
                      <div>
                         ...
                         <p className="text-[#A0A0A0] text-xs mt-1">{sponsor.description}</p>
                       </div>
                     </div>
                   </div>
                 ))}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-[#121212] rounded-2xl p-6 border border-white/10">
              <h3 className="text-lg font-semibold text-white mb-4">Statistics</h3>
                ...
                <div className="flex items-center justify-between">
                      ...
                      <span className="text-white font-semibold">{hackathon.views.toLocaleString()}</span>
                    </div>
                <div className="flex items-center justify-between">
                      <span className="text-[#A0A0A0]">Likes</span>
                      <span className="text-white font-semibold">{hackathon.likes.toLocaleString()}</span>
                    </div>
                <div className="flex items-center justify-between">
                      <span className="text-[#A0A0A0]">Rating</span>
                      <div className="flex items-center space-x-1">
                        <Star size={16} className="text-[#00CFFF]" fill="currentColor" />
                        <span className="text-white font-semibold">{hackathon.rating}</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-[#121212] rounded-2xl p-6 border border-white/10">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <div className="text-white font-medium">{hackathon.organization}</div>
                  <Link 
            ...
            <div className="p-6 border-b border-white/10">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-white">Register for Hackathon</h2>
            ...
            <div className="p-6">
              <form onSubmit={handleRegistrationSubmit} className="space-y-6">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  />
                  <label htmlFor="agreeToTerms" className="text-sm text-[#C7C7C7]">
                    I agree to the hackathon's terms and conditions and code of conduct. I understand that all work must be original and completed during the hackathon period.
                  </label>
                </div>
                ...
                <div className="flex space-x-4 pt-4">
                  ...
                  <button
                    type="submit"
                    disabled={!registrationForm.agreeToTerms || !registrationForm.fullName || !registrationForm.email}
