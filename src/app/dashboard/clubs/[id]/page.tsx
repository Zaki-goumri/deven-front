        ...
        <div className="relative h-full flex items-end p-8">
          <div className="flex items-end space-x-6 w-full">
            ...
            <div className="flex-1 text-white">
              ...
              <p className="text-xl text-[#C7C7C7] mb-4 max-w-2xl">{club.description}</p>
            ...
            <div className="bg-[#121212] rounded-2xl p-6 border border-white/10">
              ...
              <div className="space-y-4">
                {club.hackathons.map((hackathon) => (
                  <div key={hackathon.id} className="bg-[#1A1A1A] rounded-xl p-6 border border-white/5 hover:border-[#00CFFF]/20 transition-all duration-200">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        ...
                        <p className="text-[#A0A0A0] mb-4">{hackathon.description}</p>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                      <div className="text-center">
                        <div className="text-lg font-bold text-white">{hackathon.participants.toLocaleString()}</div>
                        <div className="text-xs text-[#A0A0A0]">Participants</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-bold text-white">{hackathon.prize}</div>
                        <div className="text-xs text-[#A0A0A0]">Prize Pool</div>
                      </div>
                      <div className="text-center">
                        <div className="text-lg font-bold text-white">{hackathon.likes}</div>
